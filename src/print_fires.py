...
def print_fires(file_name, country_column, country, fires_column, operation=None):
...
def main():    
    ...
    parser.add_argument('--operation', type=str, choices=['mean', 'median', 'stdev'],
                        help='Optional: Perform mean, median, or stdev on the returned fire values.')

    args = parser.parse_args()

    all_fires = print_fires(args.file_name, args.country_column, args.country, args.fires_column, args.operation)
